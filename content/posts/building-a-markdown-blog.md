...
description: Notes on a tiny blog stack with markdown posts, SQLite render caching, and inline hover notes.
author: Evan McNeely
date: 2026-04-15
tags:
  - go
...
The basic loop is intentionally small: write markdown, render it in Go, and keep the rendered HTML in SQLite so the server does not have to re-parse every post on every request.
...
- SQLite makes rendered output cheap to reuse.
